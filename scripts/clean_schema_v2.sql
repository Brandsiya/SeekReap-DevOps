-- =====================================================
-- Clean Schema Installation (Drops existing tables)
-- =====================================================
...
DROP TABLE IF EXISTS flagged_issues CASCADE;
DROP TABLE IF EXISTS platform_scans CASCADE;
DROP TABLE IF EXISTS submissions CASCADE;
DROP TABLE IF EXISTS creators CASCADE;
DROP TABLE IF EXISTS platform_policies CASCADE;
